...
import { usePlaidLinkConnect, usePlaidLinkPreview, usePlaidItems } from '../hooks/usePlaidLink';
...
export default function Accounts() {
  ...
  const { open: openPlaidDirect } = usePlaidLinkConnect(
    (data) => {
  ...
  const { open: openPlaidPreview, isLoading: plaidPreviewLoading } = usePlaidLinkPreview(
    (data) => {
    ...
    <div className="px-4 py-6">
      ...
      {accounts && accounts.length === 0 ? (
        <div className="card py-12 text-center">
          ...
          <div className="mt-4 flex gap-2 justify-center">
            <button onClick={() => setShowBankConnections(true)} className="btn-primary">
              <BankIcon className="mr-1 h-4 w-4" />
              Bank Connections
            </button>
      ...
      {showBankConnections && (
        <BankConnectionsModal
          ...
          onConnectNewBank={openPlaidLink}
          plaidConnectLoading={plaidPreviewLoading}
